...
//CM Panel Code
	...
	var cm_options = Ext.create('Ext.data.Store', {
		...
		data : [
			...
			{"category_val":"pedestrian_detection", 'name':"Pedestrian Countermeasure Effectiveness", 'target_val':"pedestrian_detection", 'base_rate':0, 'law_rate':9, 'proportion':50, 'detail_type': 'independent', 'lock': 0},
			{"category_val":"pedestrian_detection", 'name':"Animal Countermeasure Effectiveness", 'target_val':"ped_detection_animal", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent', 'lock': 0},
			...
			{"category_val":"ldp", 'name':"Rollover Effectiveness", 'target_val':"ldp", 'base_rate':0, 'law_rate':9, 'proportion':91, 'detail_type': 'independent1', 'lock': 0},
			{"category_val":"ldp", 'name':"Other Crash Effectiveness", 'target_val':"ldp_rollover", 'base_rate':0, 'law_rate':9, 'proportion':35, 'detail_type': 'independent1', 'lock': 0},
			{"category_val":"ldp", 'name':"Rollover Effectiveness", 'target_val':"lka_rollover", 'base_rate':0, 'law_rate':9, 'proportion':91, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"ldp", 'name':"Other Crash Effectiveness", 'target_val':"lka", 'base_rate':0, 'law_rate':9, 'proportion':35, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"ldp", 'name':"Rollover Effectiveness", 'target_val':"ldw_rollover", 'base_rate':0, 'law_rate':9, 'proportion':70, 'detail_type': 'independent3', 'lock': 0},
			{"category_val":"ldp", 'name':"Other Crash Effectiveness", 'target_val':"ldw", 'base_rate':0, 'law_rate':9, 'proportion':9, 'detail_type': 'independent3', 'lock': 0},
			{"category_val":"ldp", 'name':"Lane Centering Fleet Penetration", 'target_val':"PENETRATION", 'base_rate':0, 'law_rate':9, 'proportion':100, 'detail_type': 'ordered_population', 'lock': 0},
			{"category_val":"ldp", 'name':"Lane Keep Assistance Fleet Penetration", 'target_val':"PENETRATION", 'base_rate':1, 'law_rate':9, 'proportion':100, 'detail_type': 'ordered_population', 'lock': 1},
			{"category_val":"ldp", 'name':"Lane Departure Warning Fleet Penetration", 'target_val':"PENETRATION", 'base_rate':2, 'law_rate':9, 'proportion':100, 'detail_type': 'ordered_population', 'lock': 2},
			...
			{"category_val":"aeb", 'name':"Animal Detection", 'target_val':"aeb_animal", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent1', 'lock': 0},
			{"category_val":"aeb", 'name':"Cross Traffic Crashes", 'target_val':"aeb_xpath", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent1', 'lock': 0},
			{"category_val":"aeb", 'name':"Turning Same Direction Crashes", 'target_val':"aeb_turning", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent1', 'lock': 0},
			{"category_val":"aeb", 'name':"Rear End/LV Braking Effectiveness", 'target_val':"fcw_lv_decel", 'base_rate':0, 'law_rate':9, 'proportion':75, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"aeb", 'name':"Rear End/LV Stopped Effectiveness", 'target_val':"fcw_lv_stopped", 'base_rate':0, 'law_rate':9, 'proportion':78, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"aeb", 'name':"Rear End/LV Slower Effectiveness", 'target_val':"fcw_lv_slower", 'base_rate':0, 'law_rate':9, 'proportion':73, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"aeb", 'name':"Other Rear End Effectiveness", 'target_val':"fcw", 'base_rate':0, 'law_rate':9, 'proportion':68, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"aeb", 'name':"Animal Detection", 'target_val':"fcw_animal", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"aeb", 'name':"Cross Traffic Crashes", 'target_val':"fcw_xpath", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"aeb", 'name':"Turning Same Direction Crashes", 'target_val':"fcw_turning", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent2', 'lock': 0},
			{"category_val":"aeb", 'name':"Rear End/LV Braking Effectiveness", 'target_val':"acc_lv_decel", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent3', 'lock': 0},
			{"category_val":"aeb", 'name':"Rear End/LV Stopped Effectiveness", 'target_val':"acc_lv_stopped", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent3', 'lock': 0},
			{"category_val":"aeb", 'name':"Rear End/LV Slower Effectiveness", 'target_val':"acc_lv_slower", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent3', 'lock': 0},
			{"category_val":"aeb", 'name':"Other Rear End Effectiveness", 'target_val':"aeb", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent3', 'lock': 0},
			{"category_val":"aeb", 'name':"Animal Detection", 'target_val':"acc_animal", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent3', 'lock': 0},
			{"category_val":"aeb", 'name':"Cross Traffic Crashes", 'target_val':"acc_xpath", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent3', 'lock': 0},
			{"category_val":"aeb", 'name':"Turning Same Direction Crashes", 'target_val':"acc_turning", 'base_rate':0, 'law_rate':9, 'proportion':25, 'detail_type': 'independent3', 'lock': 0},
			...
			*/{"category_val":"aeb", 'name':"ACC Fleet Penetration", 'target_val':"PENETRATION", 'base_rate':0, 'law_rate':9, 'proportion':100, 'detail_type': 'ordered_population', 'lock': 0},
			...
			{"category_val":"arb", 'name':"Counter Measure Effectiveness", 'target_val':"backing", 'base_rate':0, 'law_rate':9, 'proportion':50, 'detail_type': 'independent1', 'lock': 0},
			{"category_val":"arb", 'name':"Counter Measure Effectiveness", 'target_val':"arb", 'base_rate':0, 'law_rate':9, 'proportion':50, 'detail_type': 'independent2', 'lock': 0},
