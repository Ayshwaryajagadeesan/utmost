			...
			utmost_fatality_raw_values.load({
				...
				callback: function(records, operation, success){
					...
					utmost_fatality_raw_values.each(function(record){
						...
						if((data_subset_variable=='white' && data_subset_category == "all")||(data_subset_variable=='black' && data_subset_category == "all")||(data_subset_variable=='other' && data_subset_category == "all"))
						{
							var category = record.get('crash_type');
