//Data model
	...
	function data_update(n){
		...
		else if(n==38){var data_subset_category = "2.8% and Below";}
		else if(n==39){var data_subset_category = "2.8%-6.1%";}
		else if(n==40){var data_subset_category = "6.1%-12.6%";}
		else if(n==41){var data_subset_category = "12.6%-29.5%";}
		else if(n==42){var data_subset_category = "29.5% and Above";}
		else if(n==43){var data_subset_category = "70.5% and Below";}
		else if(n==44){var data_subset_category = "70.5%-87.4%";}
		else if(n==45){var data_subset_category = "87.4%-93.9%";}
		else if(n==46){var data_subset_category = "93.9%-97.2%";}
		else if(n==47){var data_subset_category = "97.2% and Above";}
		else if(n==48){var data_subset_category = "15.6% and Below";}
		else if(n==49){var data_subset_category = "15.6%-22.0%";}
		else if(n==50){var data_subset_category = "22.0%-30.4%";}
		else if(n==51){var data_subset_category = "30.4%-43.8%";}
		else if(n==52){var data_subset_category = "43.8% and Above";}
		else if(n==53){var data_subset_category = "Less than $40,179";}
		else if(n==54){var data_subset_category = "$40,179 to $49,190";}
		else if(n==55){var data_subset_category = "$49,190 to $60,224";}
		else if(n==56){var data_subset_category = "$60,224 to $77,298";}
		else if(n==57){var data_subset_category = "Greater than $77,298";}
		...
		if (data_outcome_variable == 'person_count'){
			utmost_raw_values.load({
				...
				//	if(n!=0){
				//	single_file_export(data_outcome_variable,n,out);
				//	}
					...
					if(n!=0){
						...
						if(n==1){data_update(2);}
						if(n==2){data_update(3);}
						if(n==4){data_update(5);}
						if(n==6){data_update(7);}
						if(n==7){data_update(8);}
						if(n==8){data_update(9);}
						if(n==9){data_update(10);}
						if(n==10){data_update(11);}
						if(n==11){data_update(12);}
						if(n==12){data_update(13);}
						if(n==13){data_update(14);}
						if(n==14){data_update(15);}
						if(n==15){data_update(16);}
						if(n==17){data_update(18);}
						if(n==18){data_update(19);}
						if(n==19){data_update(20);}
						if(n==20){data_update(21);}
						if(n==21){data_update(22);}
						if(n==22 || n==16 || n==5 || n==3  )
						{
					...
					if(n!=0)
						{
							...
							if(n==20){data_update(21);}
							if(n==21){data_update(22);}
							if(n==23){data_update(24);}
							if(n==24){data_update(25);}
							if(n==25){data_update(26);}
							if(n==26){data_update(27);}
							if(n==28){data_update(29);}
							if(n==29){data_update(30);}
							if(n==30){data_update(31);}
							if(n==31){data_update(32);}
							if(n==33){data_update(34);}
							if(n==34){data_update(35);}
							if(n==35){data_update(36);}
							if(n==36){data_update(37);}
							if(n==38){data_update(39);}
							if(n==39){data_update(40);}
							if(n==40){data_update(41);}
							if(n==41){data_update(42);}
							if(n==43){data_update(44);}
							if(n==44){data_update(45);}
							if(n==45){data_update(46);}
							if(n==46){data_update(47);}
							if(n==48){data_update(49);}
							if(n==49){data_update(50);}
							if(n==50){data_update(51);}
							if(n==51){data_update(52);}
							if(n==53){data_update(54);}
							if(n==54){data_update(55);}
							if(n==55){data_update(56);}
							if(n==56){data_update(57);}
							...
							if(n==22 || n==16 || n==5 || n==3 ||n==27 || n==32 || n==37 || n==42 || n==47 || n==52 || n==57 )
							{
							// thanks stackoverflow
							var outFileBlob = new Blob([out], {type:'text/plain'});
							var outFileName = "utmost_chart_output.csv";
	...
	var utmost_csv_export = function(){
			...
			else if((data_subset_variable=='white' && data_subset_category=='all'))
		{
			...
			//fatality
			out += "\n category,"+utmost_fatality_race_chart.series.get(0).title+"\n";
			var count = utmost_fatality_race_chart_values.count();
			for (i = 0; i < count; i++){
		...
		else if((data_subset_variable=='income' && data_subset_category=='all'))
		{
			out +="\n Income";
			 if (utmost_fatality_race_chart.isVisible()) {
			//fatality
			income1=utmost_fatality_race_chart.series.get(0).title[0]
			income1=income1.replace(/,/g, '');
			income2=utmost_fatality_race_chart.series.get(0).title[1]
			income2=income2.replace(/,/g, '');
			income3=utmost_fatality_race_chart.series.get(0).title[2]
			income3=income3.replace(/,/g, '');
			income4=utmost_fatality_race_chart.series.get(0).title[3]
			income4=income4.replace(/,/g, '');
			income5=utmost_fatality_race_chart.series.get(0).title[4]
			income5=income5.replace(/,/g, '');
			out += "\n category,"+income1+','+income2+','+income3+','+income4+','+income5+"\n";
			var count = utmost_fatality_race_chart_values.count();
			for (i = 0; i < count; i++){
				out += utmost_fatality_race_chart_values.getAt(i).get('crash_type')+','+utmost_fatality_race_chart_values.getAt(i).get('q1')+','+utmost_fatality_race_chart_values.getAt(i).get('q2')+','+utmost_fatality_race_chart_values.getAt(i).get('q3')+','+utmost_fatality_race_chart_values.getAt(i).get('q4')+','+utmost_fatality_race_chart_values.getAt(i).get('q5')+'\n';
			}
	...
	/*single_file_export(data_outcome_variable,n)
	{
		if(n==1){out +="\n Large Metro";}
							if(n==2){out +="\n S/M Metro";}
							if(n==3){out +="\n Non Metro";}
						...
						for (i = 0; i < count; i++){
							...
							if(data_outcome_variable == 'injury_count'){
							out += "\n category,injury_count,adjusted_injury_count\n";
							var count = utmost_injury_chart_values.count();
							for (i = 0; i < count; i++){
								out += utmost_injury_chart_values.getAt(i).get('crash_type')+','+utmost_injury_chart_values.getAt(i).get('injury_count')+','+utmost_injury_chart_values.getAt(i).get('injury_count_adj')+'\n';
							...
							if(data_outcome_variable == 'fatality_count'){
							out += "\n category,fatality_count,adjusted_fatality_count\n";
							var count = utmost_fatality_chart_values.count();
							for (i = 0; i < count; i++){
								out += utmost_fatality_chart_values.getAt(i).get('crash_type')+','+utmost_fatality_chart_values.getAt(i).get('fatality_count')+','+utmost_fatality_chart_values.getAt(i).get('fatality_count_adj')+'\n';
