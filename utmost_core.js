...
var utmost_release_notes = "<h3>UTMOST Releases</h3><h3> 2008</h3> Initial UTMOST launch.  Data based on 2002-2006 NASS-GES and NASS-CDS.<br/><h3>February 2017</h3>Data updated using 2013-2015 NASS-GES and 2011-2015 NASS-CDS.<br/><br/>Countermeasures effectiveness updated with more recent research results.<br/><br/>Legislative countermeasures to assess GDL, child restraint laws, seatbelt laws, and motorcycle helmet laws added.<br/><br/>Visualization by age groups now possible.<br/><h3>June 2018</h3>UTMOST now allows visualization of fatal crashes, based on an average of 2011-2016 FARS data.<br/><br/>Visualization of crashes by urban, suburban, and rural (based on discontinued GES classification) now available.<br/><h3>June 2019</h3>Some countermeasures grouped to promote more consistent fleet penetration, as some countermeasures would not be provided without others.  Frontal crash countermeasures group ACC, AEB, and FCW. Lateral crash countermeasures group LCC, LKA, and LDW.  Rear crash countermeasures group rear collision warning and automatic rear braking.<br/><br/>Urbanization reconfigured to be large metro, small/medium metro, and nonmetro based on RUCC classifications.<br/><br/>Some countermeasures modified to allow application to animal crashes and cross traffic crashes.<br/><br/>Additional countermeasures include replacing older vehicles, occupant protection adjustment, and seat position population. <br/><br/>Options for viewing fatal crashes now include socioeconomic factors.  Choices are % white, % black, % other, % Hispanic, % non-Hispanic, median household income, and education (% with bachelor’s or higher) by zipcode.  Results are presented in quintiles."
var utmost_ui = {};
var utmost_loadmask = {};
	...
	utmost_ui = Ext.create('Ext.container.Viewport', {
		...
		items: [{
			...
			items: [{
				...
				tabConfig: {
					title: 'Release Notes',
					tooltip: 'UTMOST Release Notes'
				},
				html: utmost_release_notes
			}
			]
		}]
	});
